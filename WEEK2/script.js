    ...
    (Geolocation API), generate 2D and 3D graphics (Canvas and WebGL APIs), and work with audio and video (Multimedia
    APIs).
    */
    ...
    // STEP 5: Comment out the addEventListener above, and replace it with an ONCLICK attribute typed directly into the
    // EM element in the HTML - note that this is common, but it is considered to be bad practice - separate your HTML and
    // your JS
